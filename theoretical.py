...
if __name__ == '__main__':
    ...
    for case in cases:
        if case == 'wisconsin':
            irradiation_data = []
            irradiation_data.append(['indium', 'In', np.array([2.1, 2.1, 2.1, 2.2]), 1.0200e+03, 2.09e+04, 1.22e+03, 100])
            irradiation_data.append(['indium', 'InCd', np.array([2.2, 2.2, 2.0, 2.2]), 9.7500e+02, 2.13e+04, 1.21e+03, 100])
